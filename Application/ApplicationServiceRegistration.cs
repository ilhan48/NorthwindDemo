...
using Application.Services.CustomerDemographics;
using Application.Services.Employees;
using Application.Services.Regions;
using Application.Services.Shippers;
using Application.Services.Suppliers;
using Application.Services.Territories;
using Application.Services.UsStates;
...
public static class ApplicationServiceRegistration
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<ICustomerDemographicsService, CustomerDemographicsManager>();
        services.AddScoped<IEmployeesService, EmployeesManager>();
        services.AddScoped<IRegionsService, RegionsManager>();
        services.AddScoped<IShippersService, ShippersManager>();
        services.AddScoped<ISuppliersService, SuppliersManager>();
        services.AddScoped<ITerritoriesService, TerritoriesManager>();
        services.AddScoped<IUsStatesService, UsStatesManager>();
        return services;
    }
